...
public class TC011_UnsuccessfulRegistration_InvalidConfirmPassword extends TestBase {
	SignIn signIn;
	...
	@Test
	public void UnSuccessfulRegistration_InvalidConfirmPassword() throws InterruptedException{
		...
		waitFor(1);
		signIn.EnterInvalidConfirmPassword();
		waitFor(1);
		...
		if(!issucess){
			Assert.assertTrue(false, "Registration is not done for Invalid Confirm Password");
		}
		else{
